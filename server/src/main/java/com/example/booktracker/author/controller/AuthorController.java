package com.example.booktracker.author.controller;
...
public class AuthorController {
     ...
     * @return A {@link ResponseEntity} containing a map with the key "authorDetails" and the corresponding {@link AuthorWikiDTO}.
     * @throws CustomBadRequestException If the authorName parameter is empty or invalid.
     */
    @GetMapping("/authors")
    public ResponseEntity<Map<String, AuthorWikiDTO>> getDetails(@RequestParam(defaultValue = "") String authorName) {
        ...
        Map<String, AuthorWikiDTO> responseMap = new HashMap<>();

        AuthorWikiDTO authorDTO = authorService.getDetails(authorName);
